(function (global, factory) {
  ...
  function render$3(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock("div", _hoisted_1$1, [vue.createVNode(_component_grid, {
  ...
  var script$7 = {
    ...
    render: function render() {
      ...
      // Header
      var header = this.safeSlot('header', this.page) || vue.h('div', {
        class: 'vc-header'
      }, [// Header title
      vue.h('div', {
  ...
  var script$8 = {
    ...
    render: function render() {
      ...
      return vue.h('div', {
        ...
        default: function _default() {
          return vue.h(script$3, _objectSpread2(_objectSpread2({}, _this.$attrs), {}, {
            class: 'grid',
            items: _this.pages,
            rows: _this.rows,
  ...
  var render$5 = /*#__PURE__*/_withId(function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, [_hoisted_1$3, vue.createVNode("div", _hoisted_2$2, [$options.date ? (vue.openBlock(), vue.createBlock("div", _hoisted_3$1, [vue.createVNode("span", _hoisted_4, vue.toDisplayString($props.locale.format($options.date, 'WWW')), 1), vue.createVNode("span", _hoisted_5, vue.toDisplayString($props.locale.format($options.date, 'MMM')), 1), vue.createVNode("span", _hoisted_6, vue.toDisplayString($props.locale.format($options.date, 'D')), 1), vue.createVNode("span", _hoisted_7, vue.toDisplayString($props.locale.format($options.date, 'YYYY')), 1)])) : vue.createCommentVNode("", true), vue.createVNode("div", _hoisted_8, [vue.createVNode(_component_time_select, {
  ...
  var script$b = {
    ...
    render: function render() {
      ...
      var calendar = function calendar() {
        return vue.h(script$8, _objectSpread2(_objectSpread2({}, _this.$attrs), {}, {
