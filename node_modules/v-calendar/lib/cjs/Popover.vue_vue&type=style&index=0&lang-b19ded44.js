'use strict';var helpers=require('./helpers-fe8dbfcf.js'),vue=require('vue'),core=require('@popperjs/core'),CustomTransition=require('./CustomTransition.js'),styleInject_es=require('./style-inject.es-06def3b0.js');// Can't just rely on 'click' event because of oddities in mobile Safari

var addTapOrClickHandler = function addTapOrClickHandler(element, handler) {
  if (!element || !element.addEventListener || !helpers.K(handler)) {
    return null;
  } // State variables
  ...
  return function () {
    helpers.F(element, 'touchstart', touchstart);
    helpers.F(element, 'touchmove', touchmove);
    helpers.F(element, 'click', touchend);
    helpers.F(element, 'touchend', touchend);
  };
};
var addHorizontalSwipeHandler = function addHorizontalSwipeHandler(element, handler, _ref) {
  ...
  return function () {
    helpers.F(element, 'touchstart', touchStart); // off(element, 'touchmove', touchmove);
  ...
  computed: {
    content: function content() {
      ...
      return helpers.K(this.$slots.default) && this.$slots.default({
    ...
    popperOptions: function popperOptions() {
      return {
        ...
        }].concat(helpers.D(this.modifiers || [])),
  ...
  watch: {
    opts: function opts(val, oldVal) {
      if (oldVal && oldVal.callback) {
        oldVal.callback(helpers.m(helpers.m({}, oldVal), {}, {
          completed: !val,
  ...
  methods: {
    ...
    removeEvents: function removeEvents() {
      helpers.F(this.popoverEl, 'click', this.onClick);
      helpers.F(this.popoverEl, 'mouseover', this.onMouseOver);
      helpers.F(this.popoverEl, 'mouseleave', this.onMouseLeave);
      helpers.F(this.popoverEl, 'focusin', this.onFocusIn);
      helpers.F(this.popoverEl, 'focusout', this.onFocusOut);
      helpers.F(document, 'keydown', this.onDocumentKeydown);
      if (this.removeDocHandler) this.removeDocHandler();
      helpers.F(document, 'show-popover', this.onDocumentShowPopover);
      helpers.F(document, 'hide-popover', this.onDocumentHidePopover);
      helpers.F(document, 'toggle-popover', this.onDocumentTogglePopover);
      helpers.F(document, 'update-popover', this.onDocumentUpdatePopover);
    },
    ...
    onFocusOut: function onFocusOut(e) {
      if (!e.relatedTarget || !helpers.J(this.popoverEl, e.relatedTarget)) {
    ...
    onDocumentClick: function onDocumentClick(e) {
      ...
      if (helpers.J(this.popoverEl, e.target) || helpers.J(this.ref, e.target)) {
        return;
      } // Hide the popover
    ...
    show: function show() {
      ...
      var fn = function fn() {
        Object.assign(_this3, helpers.B(opts, ['id']));
    ...
    hide: function hide() {
      ...
      if (!this.ref || ref !== this.ref) {
        if (opts.callback) {
          opts.callback(helpers.m(helpers.m({}, opts), {}, {
            completed: false,
    ...
    update: function update() {
      var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      Object.assign(this, helpers.B(opts, ['id']));
      this.setupPopper();
    },
