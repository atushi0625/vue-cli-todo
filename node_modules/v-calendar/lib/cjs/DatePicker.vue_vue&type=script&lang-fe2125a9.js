'use strict';var helpers=require('./helpers-fe8dbfcf.js'),vue=require('vue'),index=require('./index-f3a4fb5b.js'),Calendar_vue_vue_type_style_index_0_lang=require('./Calendar.vue_vue&type=style&index=0&lang-f71bda5b.js'),Popover_vue_vue_type_style_index_0_lang=require('./Popover.vue_vue&type=style&index=0&lang-b19ded44.js'),CalendarDay_vue_vue_type_style_index_0_lang=require('./CalendarDay.vue_vue&type=style&index=0&lang-9a74de40.js'),TimePicker=require('./TimePicker.js');var _dateConfig = {
  type: 'auto',
  mask: 'iso',
...
var _rangeConfig = {
  start: helpers.m(helpers.m({}, _dateConfig), {}, {
    timeAdjust: '00:00:00'
  }),
  end: helpers.m(helpers.m({}, _dateConfig), {}, {
    timeAdjust: '23:59:59'
  })
};
var PATCH_KEYS = {
...
var script = {
  ...
  render: function render() {
    ...
    var timePicker = function timePicker() {
      ...
      return vue.h('div', {}, helpers.m(helpers.m({}, _this.$slots), {}, {
    ...
    var calendar = function calendar() {
      return vue.h(Calendar_vue_vue_type_style_index_0_lang.s, helpers.m(helpers.m({}, _this.$attrs), {}, {
        ...
        ref: 'calendar'
      }), helpers.m(helpers.m({}, _this.$slots), {}, {
    ...
    vue.h(Popover_vue_vue_type_style_index_0_lang.s, {
  ...
  computed: {
    ...
    slotArgs: function slotArgs() {
      ...
      var events = [true, false].map(function (isStart) {
        ...
        }, CalendarDay_vue_vue_type_style_index_0_lang.g(helpers.m(helpers.m({}, _this2.popover_), {}, {
      ...
      return {
        ...
        getPopoverTriggerEvents: CalendarDay_vue_vue_type_style_index_0_lang.g
      };
    },
    ...
    selectAttribute_: function selectAttribute_() {
      ...
      var attribute = helpers.m(helpers.m({
        key: 'select-drag'
    ...
    attributes_: function attributes_() {
      var attrs = helpers.d(this.attributes) ? helpers.D(this.attributes) : [];
  ...
  mounted: function mounted() {
    ...
    helpers.E(document, 'keydown', this.onDocumentKeyDown); // Clear drag on background click

    this.offTapOrClickHandler = Popover_vue_vue_type_style_index_0_lang.b(document, function (e) {
      if (document.body.contains(e.target) && !helpers.J(_this3.$el, e.target)) {
  ...
  beforeUnmount: function beforeUnmount() {
    // Clean up handlers
    helpers.F(document, 'keydown', this.onDocumentKeyDown);
  ...
  methods: {
    ...
    handleDayClick: function handleDayClick(day) {
      ...
      if (this.isRange) {
        if (!this.isDragging) {
          this.dragTrackingValue = helpers.m({}, day.range);
        } else {
    ...
    normalizeValue: function normalizeValue(value, config, patch, isDragging) {
      ...
      if (this.isRange) {
        ...
        if (patch !== PATCH_DATE_TIME) {
          var startParts = helpers.m(helpers.m({}, this.dateParts[0]), helpers.H(this.getDateParts(_result.start), patchKeys));

          _result.start = this.getDateFromParts(startParts);

          var endParts = helpers.m(helpers.m({}, this.dateParts[1]), helpers.H(this.getDateParts(_result.end), patchKeys));
      ...
      result = helpers.m(helpers.m({}, this.dateParts[0]), helpers.H(this.getDateParts(result), patchKeys));
    ...
    showPopover: function showPopover() {
      ...
      CalendarDay_vue_vue_type_style_index_0_lang.s(helpers.m(helpers.m({
        ref: this.$el
      }, opts), {}, {
        isInteractive: true,
        id: this.datePickerPopoverId
    ...
    hidePopover: function hidePopover() {
      var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      CalendarDay_vue_vue_type_style_index_0_lang.h(helpers.m(helpers.m({}, opts), {}, {
        id: this.datePickerPopoverId
      }));
    },
    togglePopover: function togglePopover(opts) {
      CalendarDay_vue_vue_type_style_index_0_lang.t(helpers.m(helpers.m({
        ref: this.$el
      }, opts), {}, {
        isInteractive: true,
        id: this.datePickerPopoverId
    ...
    getPageForValue: function getPageForValue(isStart) {
      if (this.hasValue(this.value_)) {
        return helpers.p(this.isRange ? this.value_[isStart ? 'start' : 'end'] : this.value_);
      }
